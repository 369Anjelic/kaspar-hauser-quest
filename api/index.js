...
app.listen(PORT, () => {
  console.log(`✅ Kaspar Hauser Server läuft auf http://localhost:${PORT}`);
  console.log(`🤖 Claude API: ${process.env.ANTHROPIC_API_KEY ? '✅ Konfiguriert' : '❌ Fehlt'}`);
  console.log(`🎤 Deepgram API: ${process.env.DEEPGRAM_API_KEY ? '✅ Konfiguriert' : '⏭️ Optional'}`);
});
